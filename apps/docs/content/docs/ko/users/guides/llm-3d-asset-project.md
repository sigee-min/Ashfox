...
description: "군생활 중 AI 도구를 분석하고 실험하면서, low poly 에셋을 실제 개발 워크플로우에 바로 붙여보려 했던 Ashfox의 시작 기록."
---
...
- low poly 수준의 자산이 실제로 쓸 만한 품질로 반복 생성되는가
- 생성 결과를 개발 워크플로우에 바로 넣을 수 있을 만큼 연결 비용이 낮은가
...
![Ashfox 결과물 애니메이션](/assets/images/ashfox-animation.gif)
...
- 단순한 에셋을 빠르게 만들 수 있는가
- 그 결과를 사용자 프로젝트에 바로 넣을 수 있는가

앞으로도 이 두 가지를 기준으로 계속 다듬어갈 생각이다.

## 참고 링크

- GitHub: [sigee-min/ashfox](https://github.com/sigee-min/ashfox)
