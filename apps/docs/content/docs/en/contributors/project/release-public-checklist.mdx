...
summary: "Public Release Checklist"
---
...
- [ ] `apps/docs/content/docs/en/guides/` reflect current payloads and constraints
...
- [ ] Changelog or release notes summarize:
  ...
  - [ ] fixes
  - [ ] known limitations
- [ ] App versions are updated only where needed (`apps/*/package.json`)
- [ ] Trigger `.github/workflows/release.yml` and verify generated notes
