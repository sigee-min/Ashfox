...
import { resolveSession } from '../../../blockbench-runtime/src/transport/mcp/routerSession';
import { SessionStore } from '../../../blockbench-runtime/src/transport/mcp/session';
import {
  MCP_PROTOCOL_VERSION_MISMATCH,
  MCP_SESSION_ID_REQUIRED
} from '../../../blockbench-runtime/src/shared/messages';

{
  ...
  if (resolved.ok) {
    ...
    if (typeof resolved.newSessionId !== 'string') {
      throw new Error('Expected a new session ID.');
    }
