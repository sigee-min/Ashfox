...
import { readAuthoringBindings } from './bindings';
import { readAuthoringCoverage } from './coverage';
import { readAuthoringFace } from './face';
import { readAuthoringRestPose } from './rest';
import {
  validateAuthoringSemanticRealization
} from './semantic';
import { readAuthoringSlots } from './slots';
import { authoringRoutingSnapshot } from './routing';
import {
