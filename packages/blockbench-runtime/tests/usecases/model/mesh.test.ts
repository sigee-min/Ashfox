...
import { MeshService } from '../../../src/usecases/model/mesh';
...
const createHarness = (options?: {
  ensureActiveError?: ToolError;
  ensureRevisionError?: ToolError;
  addMeshError?: ToolError;
  updateMeshError?: ToolError;
  deleteMeshError?: ToolError;
}): MeshHarness => {
