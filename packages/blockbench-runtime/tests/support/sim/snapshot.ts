import type { SessionState, TrackedCube, TrackedTexture } from '../../../src/session';
import type { CubeInstance, TextureInstance } from '../../../src/types/blockbench';
import type { BlockbenchSimState } from './types';
import { normalizeVec2, normalizeVec3 } from './values';
