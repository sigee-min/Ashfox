import type { Capabilities, ExportPayload, ExportResult, ToolError } from '@ashfox/blockbench-contracts/types/internal';
...
import { writeInternalFallbackExport } from './fallback';
...
const isNativeCompileAdapterMismatchMessage = (message: string): boolean =>
  String(message).includes('reading \'compileAdapter\'') ||
  String(message).includes('compile_adapter');
