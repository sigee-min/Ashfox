import type { PaintFacesPayload, PaintFacesResult, ToolError } from '@ashfox/blockbench-contracts/types/internal';
import type { TextureUsageResult } from '@ashfox/blockbench-contracts/types/textureUsage';
