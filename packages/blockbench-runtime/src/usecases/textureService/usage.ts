...
import type { PreflightUsageSummary, PreflightUvBounds } from '@ashfox/blockbench-contracts/types/internal';
...
/** Normalize the cube-face filter shared by texture use cases. */
