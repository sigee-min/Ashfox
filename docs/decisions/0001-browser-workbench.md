# ADR-0001: Build the Browser Workbench
...
Ashfox provides complete asset authoring and delivery in the AI IDE
in-app browser. The Ashfox workbench owns its editor, renderer, project state,
