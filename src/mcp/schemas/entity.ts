...
import { ENTITY_ANIMATION_CHANNELS, ENTITY_ANIMATION_TRIGGER_TYPES } from '../../shared/toolConstants';
import { numberArray } from './common';

export const entityAnimationChannelSchema: JsonSchema = {
  type: 'object',
...
export const entityAnimationTriggerSchema: JsonSchema = {
  type: 'object',
  required: ['type', 'keys'],
  additionalProperties: false,
  properties: {
